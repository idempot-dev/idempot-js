...
describe("CloudflareKvIdempotencyStore", () => {
  ...
  it("should handle missing record when looking up by fingerprint", async () => {
    ...
    storeMap.set(JSON.stringify(["idempotency", "fp", "orphaned-fp"]), "orphaned-key");
  ...
  it("should throw when completing expired record", async () => {
    ...
    storeMap.set(JSON.stringify(["idempotency", "expired-key"]), JSON.stringify(expiredRecord));
  ...
  it("should cleanup expired records", async () => {
    ...
    storeMap.set(JSON.stringify(["idempotency", "fp", "expired-fp"]), "expired-key");
  ...
  it("should not delete non-expired records during cleanup", async () => {
    ...
    storeMap.set(JSON.stringify(["idempotency", "valid-key"]), JSON.stringify(validRecord));
    storeMap.set(JSON.stringify(["idempotency", "fp", "valid-fp"]), "valid-key");
  ...
  it("should handle missing record during cleanup gracefully", async () => {
    ...
    storeMap.set(JSON.stringify(["idempotency", "fp", "missing-fp"]), "missing-key");
